...
<table class="one">
<tr><td style="text-indent: 50px; width: 40%;">PERMIT is hereby granted to</td><td style="text-align: center; font-weight: bold;"><?php echo ($rec['organization_type'] == "corporation_organization") ? strtoupper($rec['business_name']) : strtoupper($rec['full_name']); ?></td></tr>
