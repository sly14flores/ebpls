...
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2" style="text-indent: 50px;"><p>Issued this&nbsp;&nbsp;&nbsp;<?php echo addOrdinalNumberSuffix((int)date("j",strtotime($rec['date_of_application']))); ?>&nbsp;&nbsp;&nbsp;of&nbsp;&nbsp;&nbsp;<?php echo date("F, Y",strtotime($rec['date_of_application'])); ?>&nbsp;&nbsp;in Bacnotan, La Union</p></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
